...
def run():
    ...
    points_distorted = camera.distort_points(pycv.stack((xx, yy)))
    xx_distorted, yy_distorted = pycv.unstack(points_distorted)
    xx_undistorted, yy_undistorted = pycv.unstack(camera.undistort_points(pycv.stack((xx_distorted, yy_distorted))))
